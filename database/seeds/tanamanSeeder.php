...
class tanamanSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	$suhuS2       = ['22-23,30-32', 	'22-23,30-32',		'26-30',				'20-25,27-30',		'20-23,25-28'];
    	$suhuS3       = ['18-21,33-35', 	'18-21,33-35',		'16-20,30-32',			'18-20,30-34',		'18-20,28-32'];
    	$suhuN        = ['0-17,36-100', 	'0-17,36-100',		'16,32',				'18,34',			'18,32'];

    	$phS1         = ['5.5-7.0', 		'5.5-7.5',			'5.8-7.8',				'6.0-7.0',			'5.5-7.5'];
		$phS2         = ['4.5-5.4,7.1-8.0', '5.0-5.5,7.5-7.9',	'5.5-5.8,7.8-8.2',		'5.0-6.0,7.0-7.5',  '5.0-5.5,7.5-7.8'];
		$phS3         = ['1.0-4.4,8.1-10', 	'5.0,7.9',			'5.5,8.2',				'5.0,7.5',			'5.0,7.8'];
		$phN          = ['0,0', 			'5.0,7.9',			'0,0',					'0,0',				'0,0'];
		
		$lembabS1     = ['33-90', 			'33-90',			'42',					'50-80',			'24-80'];
		$lembabS2     = ['30-32',			'30-33',			'36-42',				'50,80',			'20-24,80-85'];
		$lembabS3     = ['0-29,91-100', 	'30,90',			'30-36',				'50,80',			'20,85'];
